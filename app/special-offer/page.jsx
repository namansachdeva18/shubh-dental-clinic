...
const TREATMENTS_DATA = [
  {
    ...
    emi: 'From ₹3,499/mo',
    beforeImg: '/skyalign-before.png',
    afterImg: '/skyalign-after.png',
    inclusions: [
  ...
  },
  {
    ...
    emi: 'From ₹2,999/mo',
    beforeImg: '/samedayimplants-before.png',
    afterImg: '/samedayimplants-after.png',
    inclusions: [
      'Free 3D CBCT Bone Density Assessment & Computerized Guided Mapping',
      'Flat 20% Concession on Premium Implants (Osstem / Straumann)',
  ...
  },
  {
    ...
    emi: 'From ₹3,999/mo',
    beforeImg: '/procelian veneers -before.png',
    afterImg: '/procelian veneers -after.png',
    inclusions: [
  ...
  },
  {
    ...
    emi: 'From ₹2,499/mo',
    beforeImg: '/ceramic-before.png',
    afterImg: '/ceramic-after.png',
    inclusions: [
...
const FAQS_DATA = [
  {
    ...
    a: 'When you submit your enquiry or claim via WhatsApp, you receive an instant digital voucher code (SHUBH-20-VIP). Our clinical coordinator confirms your slot, and the flat 20% concession is applied directly to your treatment estimate following your clinical assessment.'
  },
  {
    q: 'Is the 3D Digital Scan really 100% free with no hidden obligation?',
    a: 'Yes! As part of this ad campaign, your comprehensive 3D iTero® / CBCT scan and 1-on-1 consultation with our PGI MDS Specialists (worth ₹3,500) is completely complimentary with zero commitment required.'
  },
  {
    q: 'How does the 0% Interest EMI financing work?',
    a: 'We offer instant pre-approved 0% interest EMI options through major healthcare financing partners. Monthly installments start as low as ₹2,499/month with zero processing fees and flexible tenures of 6 to 18 months.'
  },
  {
    q: 'Can outstation patients or NRIs consult online first?',
    a: 'Yes! If you are residing outside Rohtak, across Haryana, Delhi NCR, or abroad (USA, UK, Canada, Australia), you can book a direct 1-on-1 Online Video Consultation with Prof. Dr. S. K. Yadav or Dr. Achla Yadav to review your photos/X-rays before visiting.'
  }
];
