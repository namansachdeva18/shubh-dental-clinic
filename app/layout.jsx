...
export const metadata = {
  metadataBase: new URL('https://www.shubhdental.com'),
  title: {
  ...
  authors: [{ name: 'Prof. Dr. S. K. Yadav', url: 'https://www.shubhdental.com/doctors/dr-sk-yadav' }],
  ...
  alternates: {
    canonical: 'https://www.shubhdental.com',
  },
};
