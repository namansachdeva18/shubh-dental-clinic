...
const NAV_ITEMS = [
  ...
  },
  {
    id: 'visit',
    category: 'tourism',
    label: 'Visiting Centers',
    sublabel: '6 Regional Hubs',
    badge: 'Haryana / Pb',
  ...
  },
  {
    id: 'implants',
    category: 'treatments',
    label: 'Same-Day Implants',
    sublabel: 'Swiss All-on-4®',
    badge: 'Fixed Teeth',
    href: '/treatments/same-day-dental-implants',
    theme: 'steel',
    vectorKey: 'implants',
  },
  {
    id: 'braces',
    category: 'treatments',
    label: 'Advanced Braces',
    sublabel: 'Self-Ligating & Metal',
    badge: 'Orthodontics',
    href: '/treatments/dental-braces',
    theme: 'coral',
    vectorKey: 'braces',
  },
  {
