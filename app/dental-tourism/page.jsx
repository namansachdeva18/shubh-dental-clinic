          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
              {[
                ...
                { icon: <ShieldCheck size={32}/>, title: "Global Premium Materials", desc: <>We use the <strong style={{ color: 'var(--accent-color)' }}>exact same genuine materials</strong>—Invisalign®, Damon® Braces, German Zirconia, and Osstem Implants—used in the <strong style={{ color: 'var(--accent-color)' }}>US, UK, and Canada</strong>.</> },
